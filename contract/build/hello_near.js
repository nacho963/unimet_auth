...
var _dec, _class;
let Certified = (_dec = NearBindgen({}), _dec(_class = class Certified {
  constructor(certified_title, certified_created_at, certified_faculty_name, certified_faculty_direction, certified_registry_number, certified_secretary_name, certified_chancellor_name, certified_resourse, certified_created_by, certified_owner) {
  ...
  transferCertified(newOwner) {
    if (signerAccountId() == this.certified_owner) {
      this.certified_owner = newOwner;
    }
  }
}) || _class);

const certifies = new UnorderedMap("certifies");

function createCertified(certified_title, certified_created_at, certified_faculty_name, certified_faculty_direction, certified_registry_number, certified_secretary_name, certified_chancellor_name, certified_resourse) {
  // Obtener el remitente actual
  const sender = signerAccountId();

  // Crear un nuevo objeto Certified
  const newCertified = new Certified(certified_title, certified_created_at, certified_faculty_name, certified_faculty_direction, certified_registry_number, certified_secretary_name, certified_chancellor_name, certified_resourse, sender, sender);
...
function transferCertified(newOwner, certified_registry_number) {
  let temCertified = certifies.get(certified_registry_number);
  temCertified?.transferCertified(newOwner);
  if (temCertified) certifies.set(certified_registry_number, temCertified);
  return temCertified;
}
...
export { createCertified, transferCertified };
